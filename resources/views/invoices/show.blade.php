    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex gap-3 flex-wrap">
                ...
                <x-ui.button variant="outline" href="{{ route('pdf.invoice', $invoice) }}" target="_blank">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <x-ui.button variant="outline" href="{{ route('pdf.invoice.stream', $invoice) }}" target="_blank">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
