    ...
    >
        <template x-for="toast in toasts" :key="toast.id">
            ...
            >
                ...
                <div class="flex-1">
                    <p class="text-sm font-medium text-secondary-900 dark:text-white" x-text="toast.title"></p>
                    <p class="text-sm text-secondary-500 dark:text-secondary-400" x-text="toast.message" x-show="toast.message"></p>
                </div>
                <button @click="removeToast(toast.id)" class="flex-shrink-0 text-secondary-400 hover:text-secondary-600 dark:hover:text-secondary-300">
