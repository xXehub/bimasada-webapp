...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="company-cell">
                ...
                <div class="company-address">
                    Pergudangan Mutiara Citra Sejati Blok D10, Jl. Raya Manukan Kulon 60, Tandes, Surabaya - Jawa
                    Timur<br>
        ...
        <div class="agreement-text">
            <p>Kedua belah telah sepakat untuk mengadakan kerjasama usaha dengan ketentuan-ketentuan yang diatur sebagai
                berikut ini :</p>
        </div>
        ...
        <div class="pasal">
            ...
            <div class="pasal-content">
                Dalam kerjasama ini Pihak Pertama akan menyediakan jasa/layanan kepada Pihak Kedua dengan nilai kontrak
                sebesar <strong>Rp {{ number_format($pks->nilai_kontrak ?? 0, 0, ',', '.') }}</strong>
                ({{ App\Helpers\Terbilang::convert($pks->nilai_kontrak ?? 0) }} rupiah) sesuai dengan kesepakatan yang
        ...
        <div class="pasal">
            ...
            <div class="pasal-content">
                Kedua belah pihak akan saling bekerjasama untuk melaksanakan hak dan kewajiban sesuai dengan ketentuan
        ...
        <div class="pasal">
            ...
            <div class="pasal-content">
                Apabila terjadi perselisihan antar kedua belah pihak akan diselesaikan secara kekeluargaan terlebih
                dahulu. Dan apabila tidak ditemui jalan keluar baru akan diselesaikan secara hukum.
            </div>
        </div>

        <!-- Closing -->
        <div class="closing">
            <p>Demikian surat perjanjian ini kami buat sebenar-benarnya dalam rangkap dua yang mana masing-masing
                rangkap mempunyai kekuatan hukum yang sama. Dan dalam pembuatan perjanjian kerjasama ini tidak ada
        ...
        <div class="signature-section">
            <div class="signature-date">
                {{ $pks->tempat_ttd ?? 'Jakarta' }},
                {{ $pks->tanggal_surat ? \Carbon\Carbon::parse($pks->tanggal_surat)->translatedFormat('d F Y') : now()->translatedFormat('d F Y') }}
            </div>
            ...
            <table class="signature-table">
                ...
                <tr>
                    <td class="signature-box"><span
                            class="signature-name">{{ $pks->nama_pihak_pertama ?? 'PT. BIMASADA JAYA PERSADA' }}</span>
                    </td>
                    <td class="signature-middle"></td>
                    <td class="signature-box"><span
                            class="signature-name">{{ $pks->nama_pihak_kedua ?? ($pks->nama_pelanggan ?? '-') }}</span>
                    </td>
                </tr>
            </table>
        </div>
