                        ...
                        columns: [
                            ...
                            { 
                                ...
                                render: function(data, type, row) {
                                    ...
                                    // Print button
                                    html += `
                                        <a href="/surat-perjanjians/${data}?print=true" target="_blank" class="p-2 rounded-lg text-gray-500 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors" title="Print">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
